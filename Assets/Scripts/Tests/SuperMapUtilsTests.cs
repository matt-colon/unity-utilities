...
namespace Tests {
    public class SuperMapUtilsTests {
      ...
      public void TestGetTileCoordinatePath() {
        ...
        Assert.AreEqual(path[3], new Vector3Int(1, -1, 0));
        ...
        Assert.AreEqual(4, path.Count);
        Assert.AreEqual(path[3], new Vector3Int(5, -1, 0));
        ...
        Assert.AreEqual(4, path.Count);
        Assert.AreEqual(path[3], new Vector3Int(5, -5, 0));
        ...
        Assert.AreEqual(4, path.Count);
        Assert.AreEqual(path[3], new Vector3Int(1, -5, 0));
        ...
        Assert.AreEqual(path[7], new Vector3Int(5, -5, 0));
        ...
        Assert.AreEqual(8, path.Count);
        Assert.AreEqual(path[7], new Vector3Int(1, -5, 0));
      }
